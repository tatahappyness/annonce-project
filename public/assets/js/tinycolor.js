...
function clickColor(hex, seltop, selleft, html5) {
    ...
    //alert(tinycolor(colorhex).toHexString());
     
    document.getElementById("apres_color").innerHTML = `
    <button class="card col-lg-12 btn "  type="button" title="Mon Couler" style="background: `+tinycolor(colorhex).toHexString()+` ;height: 5rem;">
    </button>   `;
    
    document.getElementById("theme_color_Color").value = tinycolor(colorhex).toHexString();
